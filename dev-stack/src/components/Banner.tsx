...
const Banner = () => {
    return (
        <section className="px-4 py-10 md:px-16 md:py-18"> {/*px-4 - padding left and right 1rem, py-10 - padding top and bottom 2.5rem, md:px-16 - padding left and right 4rem on medium screens and above, md:py-18 - padding top and bottom 4.5rem on medium screens and above*/}
